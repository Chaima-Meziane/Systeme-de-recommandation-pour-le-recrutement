...
import LikesCandidaturesLineChart from "./LikesCandidaturesLineChart";
    ...
    <Back title={`Tableau De Bord`} />
      <section className='testimonial padding'>
        <div className='container'>
          ...
          <br/><br/><br/>
          <div style={{marginLeft:'60px'}} className="grid-container">
          ...
          <div className='mini-box-bleue' style={{ backgroundColor: 'rgba(95,210,215,255)' , marginRight:'125px'}}>
          ...
          <div style={{marginLeft:'60px'}} className='content-box-dash small-box'>
            <div className='content'><CandidatureHistogram offerId={id} /></div>
          </div>
           
          <div className='flex-container-dash'>

        <div  style={{marginLeft:'60px'}} className='content-box-dash-doughnut'>
        ...
        <div style={{marginLeft:'60px'}} className='content-box-dash small-box'>
            <div className='content'><LikesCandidaturesLineChart offerId={id} /></div>
        </div>
